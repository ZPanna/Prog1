...
int main(){
    try{
        ...
        //12.7.3
        Axis xa {Axis::x, Point {20, 300}, 200, 10, "X axis"}; //egy x-et rajzol ki
        ...
        Graph_lib::Polygon poly; //ábrázolni fogunk, (háromszöget most?)
        ...
        Graph_lib::Rectangle r {Point{200, 200}, 100, 50}; //négyszöget rajzolunk
        win.attach(r);
